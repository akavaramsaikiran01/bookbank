...
public class UnReturned extends JFrame implements ActionListener {
    ...
    public UnReturned() {
        ...
        JLabel frameHeaderLabel = new JLabel("UnReturned Books", JLabel.CENTER); // Centered text
        ...
        try {
            Conn c = new Conn();
            String query = "SELECT * FROM statustable WHERE statuss = 'not returned'";
            ResultSet rs = c.stmt.executeQuery(query);

            if (!rs.isBeforeFirst()) {
                JOptionPane.showMessageDialog(null, "No  unreturned books found.");
            } else {
