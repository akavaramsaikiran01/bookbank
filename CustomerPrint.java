...
public class CustomerPrint extends JFrame implements ActionListener {
    ...
    public CustomerPrint() {
        ...
        JLabel frameHeaderLabel = new JLabel("Customer Details", JLabel.CENTER); // Centered text
        ...
        try {
            Conn c = new Conn();
            String query = "SELECT customerName, CustomerId, Email, JoinDate, MobileNumber FROM customers"; // Exclude Password column";
            ResultSet rs = c.stmt.executeQuery(query);

            if (!rs.isBeforeFirst()) {
                JOptionPane.showMessageDialog(null, "Hey there!\n\n\tIt looks like there are no customers yet.");
            } else {
