...
public class ReturnedBooks extends JFrame implements ActionListener {
    ...
    public ReturnedBooks() {
        ...
        JLabel frameHeaderLabel = new JLabel("Returned Books", JLabel.CENTER); // Centered text
        ...
        try {
            Conn c = new Conn();
            String query = "SELECT * FROM statustable WHERE statuss = 'returned'";
